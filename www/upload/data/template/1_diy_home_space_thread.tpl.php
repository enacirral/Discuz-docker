...
0
|| checktplrefresh('./template/default/home/space_thread.htm', './template/default/home/space_header.htm', 1700941945, 'diy', './data/template/1_diy_home_space_thread.tpl.php', './template/default', 'home/space_thread')
|| checktplrefresh('./template/default/home/space_thread.htm', './template/default/common/userabout.htm', 1700941945, 'diy', './data/template/1_diy_home_space_thread.tpl.php', './template/default', 'home/space_thread')
|| checktplrefresh('./template/default/home/space_thread.htm', './template/default/home/space_userabout.htm', 1700941945, 'diy', './data/template/1_diy_home_space_thread.tpl.php', './template/default', 'home/space_thread')
|| checktplrefresh('./template/default/home/space_thread.htm', './template/default/common/header_common.htm', 1700941945, 'diy', './data/template/1_diy_home_space_thread.tpl.php', './template/default', 'home/space_thread')
|| checktplrefresh('./template/default/home/space_thread.htm', './template/default/home/space_diy.htm', 1700941945, 'diy', './data/template/1_diy_home_space_thread.tpl.php', './template/default', 'home/space_thread')
|| checktplrefresh('./template/default/home/space_thread.htm', './template/default/home/space_header_personalnv.htm', 1700941945, 'diy', './data/template/1_diy_home_space_thread.tpl.php', './template/default', 'home/space_thread')
;?>
<?php $space_uid = $space['uid'];
$filter = array( 'common' => '已发表', 'save' => '草稿箱', 'close' => '已关闭', 'aduit' => '待审核', 'ignored' => '已忽略', 'recyclebin' => '回收站');
$_G['home_tpl_spacemenus'][] = "<a href=\"home.php?mod=space&amp;uid=$space_uid&amp;do=thread&amp;view=me\">TA 的所有帖子</a>";?><?php if($diymode) { if($_G['setting']['homepagestyle']) { $_G['cookie']['extstyle'] = false;?><!DOCTYPE html>
<html>
<head>
...
<div class="z">
<a href="./" class="nvhm" title="首页"><?php echo $_G['setting']['bbname'];?></a> <em>&rsaquo;</em>
<?php if($_G['setting']['homestyle'] && isset($_G['setting']['navs'][4])) { ?><a href="home.php"><?php echo $_G['setting']['navs'][4]['navname'];?></a> <em>&rsaquo;</em> <?php } ?>
...
<ul><?php if(isset($_G['setting']['spacenavs']) && is_array($_G['setting']['spacenavs'])) foreach($_G['setting']['spacenavs'] as $nav) { if(is_array($nav) && $nav['available'] && (!$nav['level'] || ($nav['level'] == 1 && $_G['uid']) || ($nav['level'] == 2 && $_G['adminid'] > 0) || ($nav['level'] == 3 && $_G['adminid'] == 1))) { ?>
<?php echo $nav['code'];?>
<?php } } ?>
</ul>
...
<div class="bm bw0">
<ul class="tb cl">
<?php if($_G['setting']['friendstatus']) { ?><li<?php echo $actives['we'];?>><a href="home.php?mod=space&amp;do=thread&amp;view=we">好友的帖子</a></li><?php } ?>
...
<option value="">全部好友</option><?php if(isset($userlist) && is_array($userlist)) foreach($userlist as $value) { ?><option value="<?php echo $value['fuid'];?>"<?php echo $fuid_actives[$value['fuid']];?>><?php echo $value['fusername'];?></option>
<?php } ?>
</select>
</p>
<?php } ?>
...
<td class="frm">版块<?php if($actives['me'] && $space['uid'] == $_G['uid']) { ?>/圈子<?php } ?></td>
...
<?php if($list) { if(isset($list) && is_array($list)) foreach($list as $stid => $thread) { ?><tr<?php if($actives['me'] && $viewtype=='reply' || $viewtype=='postcomment') { ?> class="bw0_all"<?php } ?>>
<td class="icn">
...
<i class="fico-vote fic6 fc-n" alt="投票"></i>
<?php } elseif($thread['special'] == 2) { ?>
<i class="fico-cart fic6 fc-n" alt="商品"></i>
<?php } elseif($thread['special'] == 3) { ?>
<i class="fico-reward fic6 fc-n" alt="悬赏"></i>
<?php } elseif($thread['special'] == 4) { ?>
<i class="fico-group fic6 fc-n" alt="活动"></i>
<?php } elseif($thread['special'] == 5) { ?>
<i class="fico-vs fic6 fc-n" alt="辩论"></i>
...
<?php if($actives['me'] && $viewtype=='reply') { if(isset($tids[$stid]) && is_array($tids[$stid])) foreach($tids[$stid] as $pid) { $post = $posts[$pid];?><tr>
<td colspan="5" class="xg1">&nbsp;<svg width="15" height="14" class="vm"><path fill="#ddd" d="M6 8v5H1V8C1 5 4 .5 6 .5V3C5 3 3.5 6 3.5 8zm8 0v5H9V8c0-3 3-7.5 5-7.5V3c-1 0-2.5 3-2.5 5z" /></svg> <a href="forum.php?mod=redirect&amp;goto=findpost&amp;ptid=<?php echo $thread['tid'];?>&amp;pid=<?php echo $pid;?>" target="_blank"><?php if($post['message'] || is_numeric($post['message'])) { ?><?php echo $post['message'];?><?php } else { ?>......<?php } ?></a> <svg width="15" height="14" class="vm"><path fill="#ddd" d="M9 6V1h5v5c0 3-3 7.5-5 7.5V11c1 0 2.5-3 2.5-5zM1 6V1h5v5c0 3-3 7.5-5 7.5V11c1 0 2.5-3 2.5-5z" /></svg></td>
</tr>

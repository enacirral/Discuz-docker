...
0
|| checktplrefresh('./template/default/forum/post.htm', './template/default/forum/post_editor_extra.htm', 1700942704, '1', './data/template/1_1_forum_post.tpl.php', './template/default', 'forum/post')
|| checktplrefresh('./template/default/forum/post.htm', './template/default/forum/post_editor_body.htm', 1700942704, '1', './data/template/1_1_forum_post.tpl.php', './template/default', 'forum/post')
|| checktplrefresh('./template/default/forum/post.htm', './template/default/forum/post_editor_attribute.htm', 1700942704, '1', './data/template/1_1_forum_post.tpl.php', './template/default', 'forum/post')
|| checktplrefresh('./template/default/forum/post.htm', './template/default/forum/seccheck_post.htm', 1700942704, '1', './data/template/1_1_forum_post.tpl.php', './template/default', 'forum/post')
|| checktplrefresh('./template/default/forum/post.htm', './template/default/common/editor_menu.htm', 1700942704, '1', './data/template/1_1_forum_post.tpl.php', './template/default', 'forum/post')
|| checktplrefresh('./template/default/forum/post.htm', './template/default/forum/editor_menu_forum.htm', 1700942704, '1', './data/template/1_1_forum_post.tpl.php', './template/default', 'forum/post')
|| checktplrefresh('./template/default/forum/post.htm', './template/default/common/upload.htm', 1700942704, '1', './data/template/1_1_forum_post.tpl.php', './template/default', 'forum/post')
|| checktplrefresh('./template/default/forum/post.htm', './template/default/common/editor.htm', 1700942704, '1', './data/template/1_1_forum_post.tpl.php', './template/default', 'forum/post')
|| checktplrefresh('./template/default/forum/post.htm', './template/default/common/seccheck.htm', 1700942704, '1', './data/template/1_1_forum_post.tpl.php', './template/default', 'forum/post')
|| checktplrefresh('./template/default/forum/post.htm', './template/default/forum/post_attachlimit.htm', 1700942704, '1', './data/template/1_1_forum_post.tpl.php', './template/default', 'forum/post')
|| checktplrefresh('./template/default/forum/post.htm', './template/default/forum/post_attachlimit.htm', 1700942704, '1', './data/template/1_1_forum_post.tpl.php', './template/default', 'forum/post')
|| checktplrefresh('./template/default/forum/post.htm', './template/default/forum/post_attachlimit.htm', 1700942704, '1', './data/template/1_1_forum_post.tpl.php', './template/default', 'forum/post')
|| checktplrefresh('./template/default/forum/post.htm', './template/default/forum/post_attachlimit.htm', 1700942704, '1', './data/template/1_1_forum_post.tpl.php', './template/default', 'forum/post')
...
<?php } if(empty($_G['forum']['threadsorts']['required']) && !$_G['forum']['allowspecialonly']) { ?><li<?php echo $postspecialcheck[0] ?? ''; ?>><a href="javascript:;" onclick="switchpost('forum.php?mod=post&action=newthread')">发表帖子</a></li><?php } if(isset($_G['forum']['threadsorts']['types']) && is_array($_G['forum']['threadsorts']['types'])) foreach($_G['forum']['threadsorts']['types'] as $tsortid => $name) { ?><li<?php if($sortid == $tsortid) { ?> class="a"<?php } ?>><a href="javascript:;" onclick="switchpost('forum.php?mod=post&action=newthread&sortid=<?php echo $tsortid;?>')"><?php echo strip_tags($name);; ?></a></li>
<?php } if($_G['group']['allowpostpoll']) { ?><li<?php echo $postspecialcheck[1] ?? ''; ?>><a href="javascript:;" onclick="switchpost('forum.php?mod=post&action=newthread&special=1')">发起投票</a></li><?php } if($_G['group']['allowpostreward']) { ?><li<?php echo $postspecialcheck[3];?>><a href="javascript:;" onclick="switchpost('forum.php?mod=post&action=newthread&special=3')">发布悬赏</a></li><?php } if($_G['group']['allowpostdebate']) { ?><li<?php echo $postspecialcheck[5];?>><a href="javascript:;" onclick="switchpost('forum.php?mod=post&action=newthread&special=5')">发起辩论</a></li><?php } if($_G['group']['allowpostactivity']) { ?><li<?php echo $postspecialcheck[4];?>><a href="javascript:;" onclick="switchpost('forum.php?mod=post&action=newthread&special=4')">发起活动</a></li><?php } if($_G['group']['allowposttrade']) { ?><li<?php echo $postspecialcheck[2];?>><a href="javascript:;" onclick="switchpost('forum.php?mod=post&action=newthread&special=2')">出售商品</a></li><?php } if($_G['setting']['threadplugins']) { if(isset($_G['forum']['threadplugin']) && is_array($_G['forum']['threadplugin'])) foreach($_G['forum']['threadplugin'] as $tpid) { if(array_key_exists($tpid, $_G['setting']['threadplugins']) && is_array($_G['group']['allowthreadplugin']) && in_array($tpid, $_G['group']['allowthreadplugin'])) { ?>
...
<ul class="xl xl1">
<?php if($savethreads) { if(isset($savethreads) && is_array($savethreads)) foreach($savethreads as $savethread) { ?><li>
...
<?php } } if($savethreadothers) { if(isset($savethreadothers) && is_array($savethreadothers)) foreach($savethreadothers as $savethread) { ?><li>
<label>[<a href="javascript:;" title="引用" onclick="insertsave(<?php echo $savethread['pid'];?>)">引用</a>]</label>
<a href="forum.php?mod=post&amp;action=edit&amp;fid=<?php echo $savethread['fid'];?>&amp;tid=<?php echo $savethread['tid'];?>&amp;pid=<?php echo $savethread['pid'];?>" class="xi2" target="_blank"><?php echo $savethread['subject'];?></a>
<span class="xg1"><?php echo $savethread['dateline'];?></span>
</li>
<?php } } ?>
<li class="xi2"><a href="home.php?mod=space&amp;do=thread&amp;view=me&amp;type=thread&amp;filter=save" target="_blank">查看所有草稿</a></li>
</ul>
</div>
...
<?php if($_GET['action'] == 'edit' && $isfirstpost && !$thread['sortid']) { if(isset($_G['forum']['threadsorts']['types']) && is_array($_G['forum']['threadsorts']['types'])) foreach($_G['forum']['threadsorts']['types'] as $tsortid => $name) { ?><li<?php if($sortid == $tsortid) { ?> class="a"<?php } ?>><a href="javascript:;" onclick="switchpost('forum.php?mod=post&action=edit&tid=<?php echo $_G['tid'];?>&pid=<?php echo $pid;?>&sortid=<?php echo $tsortid;?>')"><?php echo strip_tags($name);; ?></a></li>
<?php } } ?>
</ul>
<?php } ?>
...
<span id="custominfo" class="y cur1<?php if($_GET['action'] != 'reply') { ?> mtn<?php } ?>">&nbsp;<i class="fico-info fic4 fc-p" alt="帮助"></i></span>
<?php } ?>
...
<option value="0">选择主题分类</option><?php if(isset($_G['forum']['threadtypes']['types']) && is_array($_G['forum']['threadtypes']['types'])) foreach($_G['forum']['threadtypes']['types'] as $typeid => $name) { if(empty($_G['forum']['threadtypes']['moderators'][$typeid]) || $_G['forum']['ismoderator']) { ?>
<option value="<?php echo $typeid;?>"<?php if((isset($thread['typeid']) && $thread['typeid'] == $typeid) || getgpc('typeid') == $typeid) { ?> selected="selected"<?php } ?>><?php echo strip_tags($name); ?></option>
<?php } } ?>
</select>
<?php } else { ?>
...
<span><input type="text" name="subject" id="subject" class="px" value="<?php echo $postinfo['subject'];?>" onkeyup="dstrLenCalc(this, 'checklen', <?php echo $_G['setting']['maxsubjectsize'];?>);" style="width: 25em" /></span>
<?php } else { ?>
<span id="subjecthide" class="z">RE: <?php echo $thread['subject'];?> [<a href="javascript:;" onclick="display('subjecthide');display('subjectchk');display('subjectbox');return false;">修改</a>]</span>
<span id="subjectbox" style="display:none"><input type="text" name="subject" id="subject" class="px" value="" onkeyup="dstrLenCalc(this, 'checklen', <?php echo $_G['setting']['maxsubjectsize'];?>);" style="width: 25em" /></span>
<?php } ?>			
<span id="subjectchk"<?php if($_GET['action'] == 'reply') { ?> style="display:none"<?php } ?>>还可输入 <strong id="checklen"><?php echo $_G['setting']['maxsubjectsize'];?></strong> 个字符</span>
<script type="text/javascript">dstrLenCalc($('subject'), 'checklen', <?php echo $_G['setting']['maxsubjectsize'];?>)</script>
<?php } if($_GET['action'] == 'newthread' && !empty($modnewthreads)) { ?> <span class="xg1 xw0">(需审核)</span><?php } if($_GET['action'] == 'reply' && !empty($modnewreplies)) { ?> <span class="xg1 xw0">(需审核)</span><?php } if($_GET['action'] == 'edit' && $isfirstpost && $thread['displayorder'] == -4) { ?> <span class="xg1 xw0">(草稿)</span><?php } ?>
</div>
</div>
...
<?php } ?><div id="<?php echo $editorid;?>_body_loading"><div class="loadicon vm"></div> 请稍后 ...</div>
...
<?php } if(isset($_G['cache']['bbcodes_display'][$_G['groupid']]) && is_array($_G['cache']['bbcodes_display'][$_G['groupid']])) foreach($_G['cache']['bbcodes_display'][$_G['groupid']] as $tag => $bbcode) { ?><a id="<?php echo $editorid;?>_cst<?php echo $bbcode['params'];?>_<?php echo $tag;?>" class="cst" title="<?php echo $bbcode['explanation'];?>"><img src="<?php echo $bbcode['icon'];?>" title="<?php echo $bbcode['explanation'];?>" alt="<?php echo $tag;?>" /></a>
<?php } ?>
...
<div class="area">
<textarea name="<?php echo $editor['textarea'];?>" id="<?php echo $editorid;?>_textarea" class="pt" rows="15"><?php echo $editor['value'];?></textarea>
...
<?php if($_G['cache']['bbcodes_display'][$_G['groupid']]) { if(isset($_G['cache']['bbcodes_display'][$_G['groupid']]) && is_array($_G['cache']['bbcodes_display'][$_G['groupid']])) foreach($_G['cache']['bbcodes_display'][$_G['groupid']] as $tag => $bbcode) { ?>custombbcodes["<?php echo $tag;?>"] = {'prompt' : '<?php echo $bbcode['prompt'];?>'};
<?php } } ?>
</script>
...
<div><label>共奖励 <input type="text" name="replycredit_times" id="replycredit_times" class="px pxs vm" value="<?php if(!empty($replycredit_rule['lasttimes'])) { ?><?php echo $replycredit_rule['lasttimes'];?><?php } else { ?>1<?php } ?>" onkeyup="javascript:getreplycredit();"  onblur="extraCheck(0)" /> 次</label>, <label>单次回帖奖励: <input type="text" name="replycredit_extcredits" id="replycredit_extcredits" class="px pxs vm" value="<?php if(!empty($replycredit_rule['extcredits']) && $thread['replycredit'] > 0) { ?><?php echo $replycredit_rule['extcredits'];?><?php } else { ?>0<?php } ?>" onkeyup="javascript:getreplycredit();" onblur="extraCheck(0)" /> <?php echo $_G['setting']['extcredits'][$extcreditstype]['unit'];?><?php echo $_G['setting']['extcredits'][$extcreditstype]['title'];?></label><span class="xg1">(留空或填 0 为不奖励)</span> , <label>每人最多可获得 <select id="replycredit_membertimes" name="replycredit_membertimes" class="ps vm"><?php for($i=1;$i<11;$i++) {;?><option value="<?php echo $i;?>"<?php if(isset($replycredit_rule['membertimes']) && $replycredit_rule['membertimes'] == $i) { ?> selected="selected"<?php } ?>><?php echo $i;?></option><?php };?></select> 次</label>, <label>中奖率 <select id="replycredit_random" name="replycredit_random" class="ps vm">
 <?php for($i=100;$i>9;$i=$i-10) {;?><option value="<?php echo $i;?>"<?php if(isset($replycredit_rule['random']) && $replycredit_rule['random'] == $i) { ?> selected="selected"<?php } ?>><?php echo $i;?></option><?php };?></select> %</label></div>
...
<option value="">不限</option><?php if(isset($_G['cache']['groupreadaccess']) && is_array($_G['cache']['groupreadaccess'])) foreach($_G['cache']['groupreadaccess'] as $val) { ?><option value="<?php echo $val['readaccess'];?>" title="阅读权限: <?php echo $val['readaccess'];?>"<?php if($thread['readperm'] == $val['readaccess']) { ?> selected="selected"<?php } ?>><?php echo $val['grouptitle'];?></option>
<?php } ?>
...
<p class="mtn">最近使用标签:&nbsp;<?php $tagi = 0;?><?php if(isset($recent_use_tag) && is_array($recent_use_tag)) foreach($recent_use_tag as $var) { if($tagi) { ?>, <?php } ?><a href="javascript:;" class="xi2" onclick="$('tags').value == '' ? $('tags').value += '<?php echo $var;?>' : $('tags').value += ',<?php echo $var;?>';extraCheck(4);doane();"><?php echo $var;?></a><?php $tagi++;?><?php } ?>
</p>
<?php } ?>
</td>
</tr>
...
<dt>&nbsp;</dt>
<dd>&nbsp;</dd>
<dt><label for="replylimit">回帖限制: </label></dt>
<dd>
...
<dt><label for="creditlimit"><?php if(!empty($_G['setting']['creditstransextra'][11])) { ?><?php echo $_G['setting']['extcredits'][$_G['setting']['creditstransextra'][11]]['title'];?><?php } else { ?>积分<?php } ?>下限:</label></dt>
<dd>
...
<p class="xg1"><?php if(!empty($_G['setting']['creditstransextra'][11])) { ?>(<?php echo $_G['setting']['extcredits'][$_G['setting']['creditstransextra'][11]]['title'];?>)<?php } else { ?>总积分<?php } ?>大于此设置才能参与抢楼，可不填</p>
</dd>
</dl>
</div>
</div>
...
<?php if($_G['uid'] && $_G['group']['allowsave']) { ?>
<input type="hidden" id="postsave" name="save" value="" />
<?php if($_GET['action'] == 'newthread' && empty($modnewthreads) || $_GET['action'] == 'edit' && $isfirstpost && empty($modnewreplies) && $thread['displayorder'] == -4) { ?>
...
<ul unselectable="on"><?php if(isset($fontoptions) && is_array($fontoptions)) foreach($fontoptions as $fontname) { ?><li onclick="discuzcode('fontname', '<?php echo $fontname;?>')" style="font-family: <?php echo $fontname;?>" unselectable="on"><a href="javascript:;" title="<?php echo $fontname;?>"><?php echo $fontname;?></a></li>
<?php } ?>
</ul>
</div><?php $sizeoptions = array(1, 2, 3, 4, 5, 6, 7)?><div class="p_pop fszm" id="<?php echo $editorid;?>_fontsize_menu" style="display: none">
<ul unselectable="on"><?php if(isset($sizeoptions) && is_array($sizeoptions)) foreach($sizeoptions as $size) { ?><li onclick="discuzcode('fontsize', <?php echo $size;?>)" unselectable="on"><a href="javascript:;" title="<?php echo $size;?>"><font size="<?php echo $size;?>" unselectable="on"><?php echo $size;?></font></a></li>
<?php } ?>
</ul>
</div>
...
EOF;
 if(isset($postattachcredits) && is_array($postattachcredits)) foreach($postattachcredits as $id => $credit) { if($credit != '') { 
$creditstring .= <<<EOF
...
<?php if($albumlist) { if(isset($albumlist) && is_array($albumlist)) foreach($albumlist as $album) { ?><option value="<?php echo $album['albumid'];?>"><?php echo $album['albumname'];?></option>
<?php } } else { ?>
...
<option value="">选择相册</option><?php if(isset($albumlist) && is_array($albumlist)) foreach($albumlist as $album) { ?><option value="<?php echo $album['albumid'];?>"><?php echo $album['albumname'];?></option>
<?php } ?>
</select>
...
<?php if($allowpostimg) { ?>
ATTACHNUM['imageused'] = <?php echo (isset($imgattachs['used']) && is_array($imgattachs['used'])) ? count($imgattachs['used']) : 0; ?>;
...
ATTACHNUM['attachused'] = <?php echo (isset($attachs['used']) && is_array($attachs['used'])) ? count($attachs['used']) : 0; ?>;
...
var msg = '';<?php if(isset($attachs['unused']) && is_array($attachs['unused'])) foreach($attachs['unused'] as $attach) { if(!empty($attach['aid'])) { ?>
...
$('unusednum_attach').innerHTML = parseInt(<?php echo is_array($attachs['unused']) ? count($attachs['unused']) : 0; ?>);
<?php } if(!empty($imgattachs['unused'])) { ?>
display('attachnotice_img');
var msg = '';<?php if(isset($imgattachs['unused']) && is_array($imgattachs['unused'])) foreach($imgattachs['unused'] as $attach) { if(!empty($attach['aid'])) { ?>
...
$('unusednum_img').innerHTML = parseInt(<?php echo is_array($imgattachs['unused']) ? count($imgattachs['unused']) : 0; ?>);
<?php } ?>
setCaretAtEnd();
...
<?php } if(!empty($swfconfig['filtertype'])) { ?>
...
<?php if(isset($thread['replycredit']) && $thread['replycredit'] > 0) { ?>

...
0
|| checktplrefresh('./template/default/home/spacecp_credit_base.htm', './template/default/home/spacecp_header.htm', 1700942680, '1', './data/template/1_1_home_spacecp_credit_base.tpl.php', './template/default', 'home/spacecp_credit_base')
|| checktplrefresh('./template/default/home/spacecp_credit_base.htm', './template/default/home/spacecp_credit_header.htm', 1700942680, '1', './data/template/1_1_home_spacecp_credit_base.tpl.php', './template/default', 'home/spacecp_credit_base')
|| checktplrefresh('./template/default/home/spacecp_credit_base.htm', './template/default/common/seccheck.htm', 1700942680, '1', './data/template/1_1_home_spacecp_credit_base.tpl.php', './template/default', 'home/spacecp_credit_base')
|| checktplrefresh('./template/default/home/spacecp_credit_base.htm', './template/default/home/spacecp_footer.htm', 1700942680, '1', './data/template/1_1_home_spacecp_credit_base.tpl.php', './template/default', 'home/spacecp_credit_base')
|| checktplrefresh('./template/default/home/spacecp_credit_base.htm', './template/default/home/spacecp_header_name.htm', 1700942680, '1', './data/template/1_1_home_spacecp_credit_base.tpl.php', './template/default', 'home/spacecp_credit_base')
|| checktplrefresh('./template/default/home/spacecp_credit_base.htm', './template/default/home/spacecp_header_name.htm', 1700942680, '1', './data/template/1_1_home_spacecp_credit_base.tpl.php', './template/default', 'home/spacecp_credit_base')
;?><?php include template('common/header'); ?><div id="pt" class="bm cl">
<div class="z">
<a href="./" class="nvhm" title="首页"><?php echo $_G['setting']['bbname'];?></a> <em>&rsaquo;</em>
<a href="home.php?mod=spacecp">设置</a> <em>&rsaquo;</em><?php if(!empty($actives['profile'])) { ?>
个人资料
<?php } elseif(!empty($actives['verify'])) { ?>
认证
<?php } elseif(!empty($actives['avatar'])) { ?>
修改头像
<?php } elseif(!empty($actives['credit'])) { ?>
积分
...
<div class="mn">
<div class="bm bw0">
<h1 class="mt"><?php if(!empty($actives['profile'])) { ?>
个人资料
<?php } elseif(!empty($actives['verify'])) { ?>
认证
<?php } elseif(!empty($actives['avatar'])) { ?>
...
<?php if(($_G['setting']['ec_ratio'] && $is_enable_pay) || $_G['setting']['card']['open']) { ?>
...
<li <?php echo $opactives['transfer'] ?? ''; ?>><a href="home.php?mod=spacecp&amp;ac=credit&amp;op=transfer">转账</a></li>
...
<?php if(!empty($_G['setting']['plugins']['spacecp_credit'])) { if(isset($_G['setting']['plugins']['spacecp_credit']) && is_array($_G['setting']['plugins']['spacecp_credit'])) foreach($_G['setting']['plugins']['spacecp_credit'] as $id => $module) { if(in_array($module['adminid'], array(0, -1)) || ($module['adminid'] && $_G['adminid'] > 0 && $module['adminid'] >= $_G['adminid'])) { ?><li<?php if($_GET['id'] == $id) { ?> class="a"<?php } ?>><a href="home.php?mod=spacecp&amp;ac=plugin&amp;op=credit&amp;id=<?php echo $id;?>"><?php echo $module['name'];?></a></li><?php } } } if($op == 'rule') { ?>
<li class="y">
...
<ul class="creditl mtm bbda cl"><?php $creditid=0;?><?php if($_GET['op'] == 'base' && $_G['setting']['creditstrans']) { $creditid=$_G['setting']['creditstrans'];?><?php if($_G['setting']['extcredits'][$creditid]) { $credit=$_G['setting']['extcredits'][$creditid];?><li class="xi1 cl">
<em><?php if($credit['img']) { ?> <?php echo $credit['img'];?><?php } ?> <?php echo $credit['title'];?>: </em><?php echo getuserprofile('extcredits'.$creditid);; ?> <?php echo $credit['unit'];?> &nbsp; <?php if(($_G['setting']['ec_ratio'] && $is_enable_pay) || $_G['setting']['card']['open']) { ?><a href="home.php?mod=spacecp&amp;ac=credit&amp;op=buy" class="xi2">立即充值&raquo;</a><?php } ?></li>
<?php } } if(isset($_G['setting']['extcredits']) && is_array($_G['setting']['extcredits'])) foreach($_G['setting']['extcredits'] as $id => $credit) { if($id!=$creditid) { ?>
...
<th width="80">积分变更</th>
<th>详情</th>
<th width="110">变更时间</th>
</tr>
<?php if($loglist) { if(isset($loglist) && is_array($loglist)) foreach($loglist as $value) { $value = makecreditlog($value, $otherinfo);?><tr>
...
<?php } elseif($_GET['op'] == 'buy') { if($_G['setting']['ec_ratio'] && $is_enable_pay) { ?>
...
<th>&nbsp;</th>
<td colspan="2">
<button type="submit" name="addfundsbuysubmit_btn" class="pn" id="addfundsbuysubmit_btn" value="true"><em>充值</em></button>
</td>
</tr>
</table>
</form>
...
<?php if($seccodecheck || $secqaacheck) { ?>
</table><?php
$sectpl = <<<EOF
...
EOF;
?><?php $sechash = !isset($sechash) ? 'S'.(empty($_G['inajax']) ? '' : 'A'.random(3)).$_G['sid'] : $sechash.random(3);
...
<th>&nbsp;</th>
<td colspan="2">
<button type="submit" name="addfundscardsubmit_btn" class="pn" id="addfundscardsubmit_btn" value="true"><em>充值</em></button>
</td>
</tr>
...
<select name="tocredits" id="tocredits" class="ps" onChange="exchangecalcredit()"><?php if(isset($_G['setting']['extcredits']) && is_array($_G['setting']['extcredits'])) foreach($_G['setting']['extcredits'] as $id => $ecredits) { if($ecredits['allowexchangein'] && $ecredits['ratio']) { ?>
...
<?php } } $i=0;?><?php if(isset($_CACHE['creditsettings']) && is_array($_CACHE['creditsettings'])) foreach($_CACHE['creditsettings'] as $id => $data) { $i++;?><?php if($data['title']) { ?>
...
<select name="fromcredits" id="fromcredits_0" class="ps" style="display: none" onChange="exchangecalcredit();"><?php if(isset($_G['setting']['extcredits']) && is_array($_G['setting']['extcredits'])) foreach($_G['setting']['extcredits'] as $id => $credit) { if($credit['allowexchangeout'] && $credit['ratio']) { ?>
...
<?php } } ?>
</select><?php $i=0;?><?php if(isset($_CACHE['creditsettings']) && is_array($_CACHE['creditsettings'])) foreach($_CACHE['creditsettings'] as $id => $data) { $i++;?><select name="fromcredits_<?php echo $i;?>" id="fromcredits_<?php echo $i;?>" class="ps" style="display: none" onChange="exchangecalcredit()"><?php if(isset($data['creditsrc']) && is_array($data['creditsrc'])) foreach($data['creditsrc'] as $id => $ratio) { ?><option value="<?php echo $id;?>" unit="<?php echo $_G['setting']['extcredits'][$id]['unit'];?>" title="<?php echo $_G['setting']['extcredits'][$id]['title'];?>" ratiosrc="<?php echo $data['ratiosrc'][$id];?>" ratiodesc="<?php echo $data['ratiodesc'][$id];?>"><?php echo $_G['setting']['extcredits'][$id]['title'];?></option>
<?php } ?>
</select>
<?php } ?>
<script type="text/javascript">
...
<th>&nbsp;</th>
<td colspan="2">
<button type="submit" name="exchangesubmit_btn" id="exchangesubmit_btn" class="pn" value="true"><em>兑换</em></button>
</td>
</tr>
</table>
</form>
...
if(!tocredit) {
return;
}<?php $i=0;?><?php if(isset($_CACHE['creditsettings']) && is_array($_CACHE['creditsettings'])) foreach($_CACHE['creditsettings'] as $id => $data) { $i++;?>$('fromcredits_<?php echo $i;?>').style.display = 'none';
<?php } ?>
...
<th class="xw1">周期内最多奖励次数</th><?php if(isset($_G['setting']['extcredits']) && is_array($_G['setting']['extcredits'])) foreach($_G['setting']['extcredits'] as $key => $value) { ?><th class="xw1"><?php echo $value['title'];?></th>
<?php } ?>
</tr><?php $i = 0;?><?php if(isset($list) && is_array($list)) foreach($list as $key => $value) { $i++;?><tr<?php if($i % 2 == 0) { ?> class="alt"<?php } ?>>
<td><?php echo $value['rulename'];?></td>
<td><?php echo $_TPL['cycletype'][$value['cycletype']];?></td>
<td><?php if($value['rewardnum']) { ?><?php echo $value['rewardnum'];?><?php } else { ?>不限次数<?php } ?></td><?php if(isset($_G['setting']['extcredits']) && is_array($_G['setting']['extcredits'])) foreach($_G['setting']['extcredits'] as $key => $credit) { $creditkey = 'extcredits'.$key;?><td><?php if($value[$creditkey] > 0) { ?>+<?php echo $value[$creditkey];?><?php } elseif($value[$creditkey] < 0) { ?><?php echo $value[$creditkey];?><?php } else { ?>0<?php } ?></td>
<?php } ?>
</tr>
<?php } ?>
</table>
...
<ul>
<?php if($_G['group']['allowavatarupload']) { ?><li<?php echo $actives['avatar'] ?? ''; ?>><a href="home.php?mod=spacecp&amp;ac=avatar">修改头像</a></li><?php } ?>
<li<?php echo $actives['profile'] ?? ''; ?>><a href="home.php?mod=spacecp&amp;ac=profile">个人资料</a></li>
<?php if($_G['setting']['verify']['enabled'] && allowverify()) { ?>
<li<?php echo $actives['verify'];?>><a href="home.php?mod=spacecp&amp;ac=profile&amp;op=verify">认证</a></li>
<?php } ?>
<li<?php echo $actives['credit'] ?? ''; ?>><a href="home.php?mod=spacecp&amp;ac=credit">积分</a></li>
<?php if($_G['setting']['ec_ratio']) { ?><li<?php echo $actives['payment'] ?? ''; ?>><a href="home.php?mod=spacecp&amp;ac=payment">订单</a></li><?php } ?>

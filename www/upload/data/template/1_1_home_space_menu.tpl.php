...
0
|| checktplrefresh('./template/default/home/space_menu.htm', './template/default/home/follow_user_header.htm', 1700941935, '1', './data/template/1_1_home_space_menu.tpl.php', './template/default', 'home/space_menu')
;?>
<?php if($space['uid']) { ?>
<div id="uhd">
...
<?php } } if($_G['adminid'] == 1) { ?>
<a <?php if(helper_access::check_module('forum')) { ?>href="forum.php?mod=modcp&amp;action=thread&amp;op=post&amp;do=search&amp;searchsubmit=1&amp;users=<?php echo $encodeusername;?>" <?php } ?>id="umanageli" onmouseover="showMenu(this.id)" class="showmenu">内容管理</a>

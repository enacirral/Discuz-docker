...
<input type="button" id="backfileselection" name="backfileselection" class="backfileselection" value="Select File" />
</div>

<div id="slider" style="height: 0px; position: absolute; right: 9px; top: 105px; width: 100px;"></div>

<div class="saveAvatardiv">
<input type="submit" id="avconfirm" name="confirm" value="确定" class="saveAvatar" style="" />
</div>
